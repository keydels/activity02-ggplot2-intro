...
**Response**: The boxplots changed color, and they're not just black. The adelie penguins boxplot turned red, the chinstrap turned green, and the gentoo boxplot turned blue.
...
**Response**: The boxplot is definitely easier to see the five number summary and get more information from it. However, the jitter plot shows each point so we're able to visually observe the sample size and see where majority of the points are clustered. With the jitter plot, we can't determine the five number summary.
